        ...
        public static void Seed(AppDbContext context)
        {
            ...
            if (!context.Items.Any())
            {
                ...
                (
                    ...
                    new Item { Name = "Coca-Cola", Price = 15.95M, shortDescription = "Bautura racoritoare", LongDescription = "Lorem Ipsum", Category = Categories["Bauturi"], ImageUrl = "https://www.vibrantplate.com/wp-content/uploads/2018/01/Pommegranate-juice-06.jpg", InStock = true, isItemOfTheWeek = false, ImageThumbnailUrl = "https://www.vibrantplate.com/wp-content/uploads/2018/01/Pommegranate-juice-06.jpg", AllergyInformation = "" },
